...
public class McpStatusPanelTest {
    ...
    public void constructor_buttonTextIsMcp() {
        panel = new McpStatusPanel(mockServer, testPort);
    ...
    @Test
    public void constructor_nullServer_foregroundIsRed() {
        panel = new McpStatusPanel(null, testPort);
        assertEquals("Foreground should be red when server is null", Color.RED, panel.getForeground());
    }
